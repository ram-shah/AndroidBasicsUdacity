...
public class WordAdapter extends ArrayAdapter<Word> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        // check if the exisitng view is being reused, otherwise infate the view
        ...
        color = ContextCompat.getColor(getContext(), mBackgroundColor);
